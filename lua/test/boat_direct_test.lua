...
describe("BoatDirect", function()
  it("should direct-list-boat", function()
    local setup = boat_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-boat", setup.live and "live" or "unit")
  ...
  it("should direct-load-boat", function()
    local setup = boat_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-boat", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function boat_direct_setup(mockres)
