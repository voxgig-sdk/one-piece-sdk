...
describe("FruitDirect", function()
  it("should direct-list-fruit", function()
    local setup = fruit_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-fruit", setup.live and "live" or "unit")
  ...
  it("should direct-load-fruit", function()
    local setup = fruit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-fruit", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function fruit_direct_setup(mockres)
