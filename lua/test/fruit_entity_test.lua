...
describe("FruitEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ONEPIECE_TEST_FRUIT_ENTID JSON to run live")
      return
    end
...
function fruit_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ONEPIECE_TEST_FRUIT_ENTID")
