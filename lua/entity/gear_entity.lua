...
local GearEntity = {}
GearEntity.__index = GearEntity


function GearEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GearEntity)
  self._name = "gear"
  self._client = client
...
function GearEntity:get_name()
  return self._name
end


function GearEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GearEntity.new(self._client, opts)
end
...
function GearEntity:mark_deleted()
  self._deleted = true
end


function GearEntity:deleted()
  return true == self._deleted
end


function GearEntity:data_set(args)
  if args ~= nil then
...
function GearEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GearEntity:match_set(args)
  if args ~= nil then
...
function GearEntity:stream(action, args, callopts)
...
function GearEntity:_run_op(ctx, post_done)
  local utility = self._utility
