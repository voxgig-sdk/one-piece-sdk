...
local BoatEntity = {}
BoatEntity.__index = BoatEntity


function BoatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BoatEntity)
  self._name = "boat"
  self._client = client
...
function BoatEntity:get_name()
  return self._name
end


function BoatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BoatEntity.new(self._client, opts)
end
...
function BoatEntity:mark_deleted()
  self._deleted = true
end


function BoatEntity:deleted()
  return true == self._deleted
end


function BoatEntity:data_set(args)
  if args ~= nil then
...
function BoatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BoatEntity:match_set(args)
  if args ~= nil then
...
function BoatEntity:stream(action, args, callopts)
...
---@param reqmatch BoatLoadMatch
---@param ctrl? table
---@return Boat
---@return string? err
function BoatEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch BoatListMatch
---@param ctrl? table
---@return Boat[]
---@return string? err
function BoatEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function BoatEntity:_run_op(ctx, post_done)
  local utility = self._utility
