...
local DialEntity = {}
DialEntity.__index = DialEntity


function DialEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DialEntity)
  self._name = "dial"
  self._client = client
...
function DialEntity:get_name()
  return self._name
end


function DialEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DialEntity.new(self._client, opts)
end
...
function DialEntity:mark_deleted()
  self._deleted = true
end


function DialEntity:deleted()
  return true == self._deleted
end


function DialEntity:data_set(args)
  if args ~= nil then
...
function DialEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DialEntity:match_set(args)
  if args ~= nil then
...
function DialEntity:stream(action, args, callopts)
...
function DialEntity:_run_op(ctx, post_done)
  local utility = self._utility
