...
class DialEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DialEntity($this->_client, $opts);
    }

    /**
     * @param Dial|array $args Dial data (assoc-array) to store.
     */
    ...
    /**
     * @return Dial|array The current Dial data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dial fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dial fields).
     */
     ...
     * Load a single Dial.
     *
     * @param DialLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DialLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dial|array The loaded Dial as an assoc-array at the
    ...
    /**
     * List Dial items matching the given filter.
     *
     * @param DialListMatch|array|null $reqmatch Match filter (any subset
     *   of Dial fields) as an assoc-array; DialListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dial[]|array A list of Dial items as assoc-arrays at
