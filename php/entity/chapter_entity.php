...
class ChapterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ChapterEntity($this->_client, $opts);
    }

    /**
     * @param Chapter|array $args Chapter data (assoc-array) to store.
     */
    ...
    /**
     * @return Chapter|array The current Chapter data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Chapter fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Chapter fields).
     */
     ...
     *
     * @param ChapterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ChapterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Chapter|array The loaded Chapter as an assoc-array at the
     ...
     *
     * @param ChapterListMatch|array|null $reqmatch Match filter (any subset
     *   of Chapter fields) as an assoc-array; ChapterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Chapter[]|array A list of Chapter items as assoc-arrays at
