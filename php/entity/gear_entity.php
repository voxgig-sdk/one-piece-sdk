...
class GearEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GearEntity($this->_client, $opts);
    }

    /**
     * @param Gear|array $args Gear data (assoc-array) to store.
     */
    ...
    /**
     * @return Gear|array The current Gear data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gear fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gear fields).
     */
     ...
     * Load a single Gear.
     *
     * @param GearLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GearLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gear|array The loaded Gear as an assoc-array at the
    ...
    /**
     * List Gear items matching the given filter.
     *
     * @param GearListMatch|array|null $reqmatch Match filter (any subset
     *   of Gear fields) as an assoc-array; GearListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gear[]|array A list of Gear items as assoc-arrays at
