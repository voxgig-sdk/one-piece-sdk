...
class CharacterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CharacterEntity($this->_client, $opts);
    }

    /**
     * @param Character|array $args Character data (assoc-array) to store.
     */
    ...
    /**
     * @return Character|array The current Character data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Character fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Character fields).
     */
     ...
     *
     * @param CharacterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CharacterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Character|array The loaded Character as an assoc-array at the
     ...
     *
     * @param CharacterListMatch|array|null $reqmatch Match filter (any subset
     *   of Character fields) as an assoc-array; CharacterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Character[]|array A list of Character items as assoc-arrays at
