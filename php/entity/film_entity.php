...
class FilmEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FilmEntity($this->_client, $opts);
    }

    /**
     * @param Film|array $args Film data (assoc-array) to store.
     */
    ...
    /**
     * @return Film|array The current Film data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Film fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Film fields).
     */
     ...
     * Load a single Film.
     *
     * @param FilmLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FilmLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Film|array The loaded Film as an assoc-array at the
    ...
    /**
     * List Film items matching the given filter.
     *
     * @param FilmListMatch|array|null $reqmatch Match filter (any subset
     *   of Film fields) as an assoc-array; FilmListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Film[]|array A list of Film items as assoc-arrays at
