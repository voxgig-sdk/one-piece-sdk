...
class BowEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BowEntity($this->_client, $opts);
    }

    /**
     * @param Bow|array $args Bow data (assoc-array) to store.
     */
    ...
    /**
     * @return Bow|array The current Bow data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Bow fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Bow fields).
     */
     ...
     * Load a single Bow.
     *
     * @param BowLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BowLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Bow|array The loaded Bow as an assoc-array at the
    ...
    /**
     * List Bow items matching the given filter.
     *
     * @param BowListMatch|array|null $reqmatch Match filter (any subset
     *   of Bow fields) as an assoc-array; BowListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Bow[]|array A list of Bow items as assoc-arrays at
