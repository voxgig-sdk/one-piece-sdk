...
// OnePiece SDK streaming feature
...
class OnePieceStreamingFeature extends OnePieceBaseFeature
{
    ...
    private function _iterate(OnePieceResult $result): \Generator
    {
    ...
    private function _streamable(OnePieceContext $ctx): bool
    {
