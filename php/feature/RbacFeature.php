...
class OnePieceRbacFeature extends OnePieceBaseFeature
{
    ...
    private function _required(OnePieceContext $ctx): ?string
    {
    ...
    private function _reject(OnePieceContext $ctx, string $required): void
    {
    ...
    private function _track(OnePieceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
