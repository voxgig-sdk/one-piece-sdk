...
class OnePieceCacheFeature extends OnePieceBaseFeature
{
    ...
    private function _through(OnePieceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
