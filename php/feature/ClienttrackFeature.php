...
// OnePiece SDK clienttrack feature
...
class OnePieceClienttrackFeature extends OnePieceBaseFeature
{
    ...
    public function PostConstruct(OnePieceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OnePiece-SDK';
