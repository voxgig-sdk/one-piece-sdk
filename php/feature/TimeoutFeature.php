...
class OnePieceTimeoutFeature extends OnePieceBaseFeature
{
    ...
    private function _with_timeout(OnePieceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OnePieceContext $_ctx, float $ms): void
    {
        $client = $this->client;
