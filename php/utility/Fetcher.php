...
// OnePiece SDK utility: fetcher

class OnePieceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OnePieceSDK/1.0)';
    ...
    public static function call(OnePieceContext $ctx, string $fullurl, array $fetchdef): array
    {
