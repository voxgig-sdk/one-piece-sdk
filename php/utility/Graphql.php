...
class OnePieceGraphql
{
    ...
    // equivalent.
    public static function body(OnePieceContext $ctx): mixed
    {
    ...
    public static function errors(OnePieceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
