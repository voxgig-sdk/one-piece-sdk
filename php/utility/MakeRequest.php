...
// OnePiece SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OnePieceMakeRequest
{
    public static function call(OnePieceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OnePieceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OnePieceResponse($fetched);
        } else {
