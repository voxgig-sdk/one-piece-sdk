...
// OnePiece SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OnePieceSDK::test)
...
{
    private const SDK_CLASS = 'OnePieceSDK';
    ...
    private const SDK_BASE = 'onepiece_sdk';
