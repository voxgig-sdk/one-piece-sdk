...
class CrewEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ONE_PIECE_TEST_CREW_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function crew_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ONE_PIECE_TEST_CREW_ENTID");
