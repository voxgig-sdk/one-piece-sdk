...
from projectname_sdk import OnePieceSDK
from projectname_sdk.core.spec import OnePieceSpec
from projectname_sdk.core.result import OnePieceResult
from projectname_sdk.core.response import OnePieceResponse
from projectname_sdk.core.operation import OnePieceOperation
from projectname_sdk.core.error import OnePieceError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import OnePieceBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = OnePieceSDK.test(None, None)
        ...
        class TestInitFeature(OnePieceBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(OnePieceBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = OnePieceSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = OnePieceSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = OnePieceSDK.test(None, setup_opts)
