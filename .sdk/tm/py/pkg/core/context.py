...
from projectname_sdk.core.control import OnePieceControl
...
class OnePieceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, OnePieceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OnePieceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OnePieceError(code, msg, self)
