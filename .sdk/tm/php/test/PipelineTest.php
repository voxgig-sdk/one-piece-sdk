...
{
    private static function utility(): OnePieceUtility
    {
        return new OnePieceUtility();
    }
    ...
    private static function ctx(array $over = []): OnePieceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new OnePieceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new OnePieceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof OnePieceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new OnePieceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = OnePieceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new OnePieceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = OnePieceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new OnePieceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = OnePieceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OnePieceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = OnePieceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new OnePieceResponse([]),
            'result' => new OnePieceResult([]),
        ]);
        [, $err] = OnePieceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new OnePieceSpec([]),
            'response' => null,
            'result' => new OnePieceResult([]),
        ]);
        [, $err] = OnePieceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new OnePieceSpec(['step' => 's']),
            'response' => new OnePieceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new OnePieceResult([]),
        ]);
        [, $err] = OnePieceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new OnePieceSpec(['step' => 's']),
            'response' => new OnePieceResponse(self::resp(200, ['v' => 1])),
            'result' => new OnePieceResult([]),
        ]);
        [, $err] = OnePieceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new OnePieceSpec(['step' => 's']),
            'response' => new OnePieceResponse(self::resp(200, ['v' => 2])),
            'result' => new OnePieceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        OnePieceMakeResponse::call($ctx);
    ...
    {
        $preset = new OnePieceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new OnePieceSpec([]),
            'response' => new OnePieceResponse([]),
            'result' => new OnePieceResult([]),
        ...
        [$got, $err] = OnePieceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new OnePieceResult([])]);
        [, $err] = OnePieceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new OnePieceSpec([]), 'result' => null]);
        [, $err] = OnePieceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OnePieceSpec(['step' => 's']),
            'result' => new OnePieceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new OnePieceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OnePieceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OnePieceSpec(['step' => 's']),
            'result' => new OnePieceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new OnePieceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OnePieceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OnePieceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new OnePieceSpec([]),
            'result' => new OnePieceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = OnePieceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OnePieceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new OnePieceError('boom', 'boom');
        $utility->fetcher = function (OnePieceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OnePieceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = OnePieceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (OnePieceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = OnePieceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(OnePieceResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (OnePieceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OnePieceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = OnePieceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new OnePieceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new OnePieceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = OnePieceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = OnePieceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = OnePieceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new OnePieceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, OnePieceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new OnePieceResult(['ok' => false])]);
        $this->expectException(OnePieceError::class);
        OnePieceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new OnePieceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', OnePieceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        OnePieceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new OnePieceBaseFeature();
        $b = new OnePieceBaseFeature();
        OnePieceFeatureAdd::call($ctx, $a);
        OnePieceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): OnePieceBaseFeature
    {
        $f = new OnePieceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        OnePieceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): OnePieceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new OnePieceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OnePiecePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new OnePieceResponse(['headers' => null]),
            'result' => new OnePieceResult([]),
        ]);
        OnePieceResultHeaders::call($ctx);
