...
// OnePiece SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OnePieceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OnePieceOmni::structfix($now, Struct::undef()))
                        !== json_encode(OnePieceOmni::structfix($val, Struct::undef()))) {
