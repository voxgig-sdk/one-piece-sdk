...
class OnePieceProxyFeature extends OnePieceBaseFeature
{
    ...
    public function init(OnePieceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OnePieceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
