...
// OnePiece SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class OnePieceTestFeature extends OnePieceBaseFeature
{
    ...
    public function init(OnePieceContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OnePieceContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OnePieceContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OnePieceContext $ctx, $op, $args): array
    {
