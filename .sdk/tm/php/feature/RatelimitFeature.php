...
// OnePiece SDK ratelimit feature
...
class OnePieceRatelimitFeature extends OnePieceBaseFeature
{
    ...
    private function _acquire(OnePieceContext $ctx): void
    {
    ...
    private function _track(OnePieceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
