...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = OnePieceOmni.make_runner(TEST_JSON_FILE, OnePieceSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : OnePieceOmni.errify(err)
    end
