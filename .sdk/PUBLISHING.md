...
|---|---|---|
| `ts/` | @voxgig-sdk/one-piece-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/one-piece-sdk \
      --repository voxgig-sdk/one-piece-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/one-piece-sdk` shows it, and
`npm trust revoke @voxgig-sdk/one-piece-sdk --id=<id>` removes it.
