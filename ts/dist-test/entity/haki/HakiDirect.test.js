...
(0, node_test_1.describe)('HakiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-haki', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-haki', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-haki', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-haki', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ONE_PIECE_TEST_HAKI_ENTID'];
...
//# sourceMappingURL=HakiDirect.test.js.map