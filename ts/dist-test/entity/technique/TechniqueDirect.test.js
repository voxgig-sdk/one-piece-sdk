...
(0, node_test_1.describe)('TechniqueDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-technique', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-technique', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-technique', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-technique', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ONE_PIECE_TEST_TECHNIQUE_ENTID'];
...
//# sourceMappingURL=TechniqueDirect.test.js.map