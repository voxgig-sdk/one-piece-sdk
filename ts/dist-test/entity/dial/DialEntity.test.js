...
(0, node_test_1.describe)('DialEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/dial/DialTestData.json');
    ...
    let idmap = transform(['dial01', 'dial02', 'dial03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DialEntity.test.js.map