...
(0, node_test_1.describe)('BoatEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/boat/BoatTestData.json');
    ...
    let idmap = transform(['boat01', 'boat02', 'boat03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BoatEntity.test.js.map