...
(0, node_test_1.describe)('CharacterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-character', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-character', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-character', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-character', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.ONE_PIECE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OnePieceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ONE_PIECE_TEST_CHARACTER_ENTID'];
    ...
    const client = new __1.OnePieceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CharacterDirect.test.js.map