...
(0, node_test_1.describe)('SwordDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-sword', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-sword', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-sword', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-sword', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ONE_PIECE_TEST_SWORD_ENTID'];
...
//# sourceMappingURL=SwordDirect.test.js.map