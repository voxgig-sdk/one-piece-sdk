...
class CharacterEntity extends OnePieceEntityBase<Character> {
  ...
  make(this: CharacterEntity) {
    return new CharacterEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CharacterLoadMatch, ctrl?: Control): Promise<CharacterEntity> {
