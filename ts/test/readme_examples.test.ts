...
//     (\`new OnePieceSDK(...)\` / \`OnePieceSDK.test(...)\` become
//     \`OnePieceSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"boat":{"test01":{"id":"test01"}},"bow":{"test01":{"id":"test01"}},"chapter":{"test01":{"id":"test01"}},"character":{"test01":{"id":"test01"}},"crew":{"test01":{"id":"test01"}},"dial":{"test01":{"id":"test01"}},"episode":{"test01":{"id":"test01"}},"film":{"test01":{"id":"test01"}},"fruit":{"test01":{"id":"test01"}},"gear":{"test01":{"id":"test01"}},"haki":{"test01":{"id":"test01"}},"location":{"test01":{"id":"test01"}},"saga":{"test01":{"id":"test01"}},"sword":{"test01":{"id":"test01"}},"technique":{"test01":{"id":"test01"}},"volume":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new OnePieceSDK(...)\` and any
// \`OnePieceSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+OnePieceSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/OnePieceSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
