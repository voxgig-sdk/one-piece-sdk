...
describe('exists', async () => {
  ...
  //
  // OnePieceSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof OnePieceSDK, true,
      'OnePieceSDK.test() must return a client synchronously')
  })
