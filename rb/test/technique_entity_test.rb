...
class TechniqueEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ONEPIECE_TEST_TECHNIQUE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def technique_basic_setup(extra)
  ...
  entid_env_raw = ENV["ONEPIECE_TEST_TECHNIQUE_ENTID"]
