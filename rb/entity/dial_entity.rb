...
class DialEntity
  ...
  # @return [Dial, Hash] the current Dial data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Dial fields)
  def match_get
  ...
  # Load a single Dial.
  #
  # @param reqmatch [DialLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Dial.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Dial, Hash] the loaded Dial; raises OnePieceError on failure
  ...
  #
  # @param reqmatch [DialListMatch, Hash, nil] match filter (any subset of
  #   Dial fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Dial>, Array] the matching Dial items; raises OnePieceError on failure
