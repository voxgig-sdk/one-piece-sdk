...
class HakiEntity
  ...
  #   as an empty match, so client.Haki.load works with no args).
  ...
  #
  # @param reqmatch [HakiListMatch, Hash, nil] match filter (any subset of
  #   Haki fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
