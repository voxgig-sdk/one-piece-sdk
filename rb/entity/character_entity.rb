...
class CharacterEntity
  ...
  def make
    opts = @_entopts.dup
    CharacterEntity.new(@_client, opts)
  end
  ...
  #   as an empty match, so client.Character.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Character, Hash] the loaded Character; raises OnePieceError on failure
  ...
  #
  # @param reqmatch [CharacterListMatch, Hash, nil] match filter (any subset of
  #   Character fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Character>, Array] the matching Character items; raises OnePieceError on failure
