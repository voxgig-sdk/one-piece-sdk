...
class BoatEntity
  ...
  # @return [Boat, Hash] the current Boat data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Boat fields)
  def match_get
  ...
  # Load a single Boat.
  #
  # @param reqmatch [BoatLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Boat.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Boat, Hash] the loaded Boat; raises OnePieceError on failure
  ...
  #
  # @param reqmatch [BoatListMatch, Hash, nil] match filter (any subset of
  #   Boat fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Boat>, Array] the matching Boat items; raises OnePieceError on failure
