...
class LocationEntity
  ...
  #   as an empty match, so client.Location.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Location, Hash] the loaded Location; raises OnePieceError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Location>, Array] the matching Location items; raises OnePieceError on failure
