...
class GearEntity
  ...
  # @return [Gear, Hash] the current Gear data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Gear fields)
  def match_get
  ...
  # Load a single Gear.
  #
  # @param reqmatch [GearLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Gear.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Gear, Hash] the loaded Gear; raises OnePieceError on failure
  ...
  #
  # @param reqmatch [GearListMatch, Hash, nil] match filter (any subset of
  #   Gear fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Gear>, Array] the matching Gear items; raises OnePieceError on failure
