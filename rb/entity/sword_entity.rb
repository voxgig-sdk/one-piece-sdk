...
class SwordEntity
  ...
  #   as an empty match, so client.Sword.load works with no args).
  ...
  #
  # @param reqmatch [SwordListMatch, Hash, nil] match filter (any subset of
  #   Sword fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
