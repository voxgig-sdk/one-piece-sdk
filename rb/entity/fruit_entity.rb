...
class FruitEntity
  ...
  #   as an empty match, so client.Fruit.load works with no args).
  ...
  #
  # @param reqmatch [FruitListMatch, Hash, nil] match filter (any subset of
  #   Fruit fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
