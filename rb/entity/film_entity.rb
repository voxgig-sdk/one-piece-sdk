...
class FilmEntity
  ...
  # @return [Film, Hash] the current Film data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Film fields)
  def match_get
  ...
  # Load a single Film.
  #
  # @param reqmatch [FilmLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Film.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Film, Hash] the loaded Film; raises OnePieceError on failure
  ...
  #
  # @param reqmatch [FilmListMatch, Hash, nil] match filter (any subset of
  #   Film fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Film>, Array] the matching Film items; raises OnePieceError on failure
