...
func registerSDKWords(r *eng.Registry, client *sdk.OnePieceSDK) {
...
func runOp(client *sdk.OnePieceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
