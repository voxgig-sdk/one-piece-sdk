...
The Golang SDK for the OnePiece API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/one-piece-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/one-piece-sdk=../path/to/github.com/voxgig-sdk/one-piece-sdk
```
...
```
github.com/voxgig-sdk/one-piece-sdk/
...
The root package (`github.com/voxgig-sdk/one-piece-sdk`) re-exports everything needed
