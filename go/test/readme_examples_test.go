...
const testSeed = `map[string]any{"entity": map[string]any{"boat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bow": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "chapter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "crew": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dial": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "film": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fruit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "gear": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "haki": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "saga": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sword": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "technique": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "volume": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
