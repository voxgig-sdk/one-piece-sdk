...
func TestLocationEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set ONE_PIECE_TEST_LOCATION_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func locationBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("ONE_PIECE_TEST_LOCATION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["ONE_PIECE_TEST_LOCATION_ENTID"])
