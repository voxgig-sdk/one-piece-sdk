...
func NewCharacterEntity(client *core.OnePieceSDK, entopts map[string]any) *CharacterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CharacterEntity) GetName() string { return e.name }
...
func (e *CharacterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CharacterEntity) Deleted() bool {
	return e.deleted
}


func (e *CharacterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCharacterEntity(e.client, opts)
}

func (e *CharacterEntity) Data(args ...any) any {
...
func (e *CharacterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Character; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CharacterEntity) DataTyped(data ...Character) Character {
	if len(data) > 0 {
		return typedFrom[Character](e.Data(asMap(data[0])))
	}
	return typedFrom[Character](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Character (all fields
// optional at the wire level).
func (e *CharacterEntity) MatchTyped(match ...Character) Character {
	if len(match) > 0 {
		return typedFrom[Character](e.Match(asMap(match[0])))
	}
	return typedFrom[Character](e.Match())
}
...
func (e *CharacterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CharacterEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CharacterLoadMatch and returns an Character. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CharacterEntity) LoadTyped(reqmatch CharacterLoadMatch, ctrl map[string]any) (Character, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Character{}, err
	}
	return typedFrom[Character](res), nil
}




func (e *CharacterEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CharacterListMatch and returns []Character. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CharacterEntity) ListTyped(reqmatch CharacterListMatch, ctrl map[string]any) ([]Character, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Character](res), nil
}



func (e *CharacterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CharacterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CharacterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CharacterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
