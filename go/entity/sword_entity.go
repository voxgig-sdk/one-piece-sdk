...
func NewSwordEntity(client *core.OnePieceSDK, entopts map[string]any) *SwordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SwordEntity) GetName() string { return e.name }
...
func (e *SwordEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SwordEntity) Deleted() bool {
	return e.deleted
}


func (e *SwordEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSwordEntity(e.client, opts)
}

func (e *SwordEntity) Data(args ...any) any {
...
func (e *SwordEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Sword; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SwordEntity) DataTyped(data ...Sword) Sword {
	if len(data) > 0 {
		return typedFrom[Sword](e.Data(asMap(data[0])))
	}
	return typedFrom[Sword](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Sword (all fields
// optional at the wire level).
func (e *SwordEntity) MatchTyped(match ...Sword) Sword {
	if len(match) > 0 {
		return typedFrom[Sword](e.Match(asMap(match[0])))
	}
	return typedFrom[Sword](e.Match())
}
...
func (e *SwordEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SwordEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SwordLoadMatch and returns an Sword. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SwordEntity) LoadTyped(reqmatch SwordLoadMatch, ctrl map[string]any) (Sword, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Sword{}, err
	}
	return typedFrom[Sword](res), nil
}




func (e *SwordEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SwordListMatch and returns []Sword. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SwordEntity) ListTyped(reqmatch SwordListMatch, ctrl map[string]any) ([]Sword, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Sword](res), nil
}



func (e *SwordEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SwordEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SwordEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SwordEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
