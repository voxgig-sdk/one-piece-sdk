...
func NewSagaEntity(client *core.OnePieceSDK, entopts map[string]any) *SagaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SagaEntity) GetName() string { return e.name }
...
func (e *SagaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SagaEntity) Deleted() bool {
	return e.deleted
}


func (e *SagaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSagaEntity(e.client, opts)
}

func (e *SagaEntity) Data(args ...any) any {
...
func (e *SagaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Saga; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SagaEntity) DataTyped(data ...Saga) Saga {
	if len(data) > 0 {
		return typedFrom[Saga](e.Data(asMap(data[0])))
	}
	return typedFrom[Saga](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Saga (all fields
// optional at the wire level).
func (e *SagaEntity) MatchTyped(match ...Saga) Saga {
	if len(match) > 0 {
		return typedFrom[Saga](e.Match(asMap(match[0])))
	}
	return typedFrom[Saga](e.Match())
}
...
func (e *SagaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SagaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SagaLoadMatch and returns an Saga. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SagaEntity) LoadTyped(reqmatch SagaLoadMatch, ctrl map[string]any) (Saga, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Saga{}, err
	}
	return typedFrom[Saga](res), nil
}




func (e *SagaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SagaListMatch and returns []Saga. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SagaEntity) ListTyped(reqmatch SagaListMatch, ctrl map[string]any) ([]Saga, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Saga](res), nil
}



func (e *SagaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SagaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SagaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SagaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
