...
func NewFilmEntity(client *core.OnePieceSDK, entopts map[string]any) *FilmEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FilmEntity) GetName() string { return e.name }
...
func (e *FilmEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FilmEntity) Deleted() bool {
	return e.deleted
}


func (e *FilmEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFilmEntity(e.client, opts)
}

func (e *FilmEntity) Data(args ...any) any {
...
func (e *FilmEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Film; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FilmEntity) DataTyped(data ...Film) Film {
	if len(data) > 0 {
		return typedFrom[Film](e.Data(asMap(data[0])))
	}
	return typedFrom[Film](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Film (all fields
// optional at the wire level).
func (e *FilmEntity) MatchTyped(match ...Film) Film {
	if len(match) > 0 {
		return typedFrom[Film](e.Match(asMap(match[0])))
	}
	return typedFrom[Film](e.Match())
}
...
func (e *FilmEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FilmEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FilmLoadMatch and returns an Film. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FilmEntity) LoadTyped(reqmatch FilmLoadMatch, ctrl map[string]any) (Film, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Film{}, err
	}
	return typedFrom[Film](res), nil
}




func (e *FilmEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FilmListMatch and returns []Film. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FilmEntity) ListTyped(reqmatch FilmListMatch, ctrl map[string]any) ([]Film, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Film](res), nil
}



func (e *FilmEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FilmEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FilmEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FilmEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
