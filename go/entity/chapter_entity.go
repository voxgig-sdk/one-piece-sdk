...
func NewChapterEntity(client *core.OnePieceSDK, entopts map[string]any) *ChapterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ChapterEntity) GetName() string { return e.name }
...
func (e *ChapterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ChapterEntity) Deleted() bool {
	return e.deleted
}


func (e *ChapterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewChapterEntity(e.client, opts)
}

func (e *ChapterEntity) Data(args ...any) any {
...
func (e *ChapterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ChapterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ChapterEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *ChapterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ChapterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ChapterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ChapterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
