...
func NewBowEntity(client *core.OnePieceSDK, entopts map[string]any) *BowEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BowEntity) GetName() string { return e.name }
...
func (e *BowEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BowEntity) Deleted() bool {
	return e.deleted
}


func (e *BowEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBowEntity(e.client, opts)
}

func (e *BowEntity) Data(args ...any) any {
...
func (e *BowEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *BowEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BowEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *BowEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BowEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BowEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BowEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
