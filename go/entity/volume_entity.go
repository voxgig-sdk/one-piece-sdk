...
func NewVolumeEntity(client *core.OnePieceSDK, entopts map[string]any) *VolumeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VolumeEntity) GetName() string { return e.name }
...
func (e *VolumeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VolumeEntity) Deleted() bool {
	return e.deleted
}


func (e *VolumeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVolumeEntity(e.client, opts)
}

func (e *VolumeEntity) Data(args ...any) any {
...
func (e *VolumeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Volume; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VolumeEntity) DataTyped(data ...Volume) Volume {
	if len(data) > 0 {
		return typedFrom[Volume](e.Data(asMap(data[0])))
	}
	return typedFrom[Volume](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Volume (all fields
// optional at the wire level).
func (e *VolumeEntity) MatchTyped(match ...Volume) Volume {
	if len(match) > 0 {
		return typedFrom[Volume](e.Match(asMap(match[0])))
	}
	return typedFrom[Volume](e.Match())
}
...
func (e *VolumeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VolumeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VolumeLoadMatch and returns an Volume. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VolumeEntity) LoadTyped(reqmatch VolumeLoadMatch, ctrl map[string]any) (Volume, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Volume{}, err
	}
	return typedFrom[Volume](res), nil
}




func (e *VolumeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// VolumeListMatch and returns []Volume. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VolumeEntity) ListTyped(reqmatch VolumeListMatch, ctrl map[string]any) ([]Volume, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Volume](res), nil
}



func (e *VolumeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VolumeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VolumeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VolumeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
