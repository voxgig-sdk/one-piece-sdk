...
func NewGearEntity(client *core.OnePieceSDK, entopts map[string]any) *GearEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GearEntity) GetName() string { return e.name }
...
func (e *GearEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GearEntity) Deleted() bool {
	return e.deleted
}


func (e *GearEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGearEntity(e.client, opts)
}

func (e *GearEntity) Data(args ...any) any {
...
func (e *GearEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Gear; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GearEntity) DataTyped(data ...Gear) Gear {
	if len(data) > 0 {
		return typedFrom[Gear](e.Data(asMap(data[0])))
	}
	return typedFrom[Gear](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Gear (all fields
// optional at the wire level).
func (e *GearEntity) MatchTyped(match ...Gear) Gear {
	if len(match) > 0 {
		return typedFrom[Gear](e.Match(asMap(match[0])))
	}
	return typedFrom[Gear](e.Match())
}
...
func (e *GearEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GearEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GearLoadMatch and returns an Gear. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GearEntity) LoadTyped(reqmatch GearLoadMatch, ctrl map[string]any) (Gear, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Gear{}, err
	}
	return typedFrom[Gear](res), nil
}




func (e *GearEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GearListMatch and returns []Gear. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GearEntity) ListTyped(reqmatch GearListMatch, ctrl map[string]any) ([]Gear, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Gear](res), nil
}



func (e *GearEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GearEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GearEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GearEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
