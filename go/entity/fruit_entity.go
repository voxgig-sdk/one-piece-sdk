...
func NewFruitEntity(client *core.OnePieceSDK, entopts map[string]any) *FruitEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FruitEntity) GetName() string { return e.name }
...
func (e *FruitEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FruitEntity) Deleted() bool {
	return e.deleted
}


func (e *FruitEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFruitEntity(e.client, opts)
}

func (e *FruitEntity) Data(args ...any) any {
...
func (e *FruitEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Fruit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FruitEntity) DataTyped(data ...Fruit) Fruit {
	if len(data) > 0 {
		return typedFrom[Fruit](e.Data(asMap(data[0])))
	}
	return typedFrom[Fruit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Fruit (all fields
// optional at the wire level).
func (e *FruitEntity) MatchTyped(match ...Fruit) Fruit {
	if len(match) > 0 {
		return typedFrom[Fruit](e.Match(asMap(match[0])))
	}
	return typedFrom[Fruit](e.Match())
}
...
func (e *FruitEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FruitEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FruitLoadMatch and returns an Fruit. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FruitEntity) LoadTyped(reqmatch FruitLoadMatch, ctrl map[string]any) (Fruit, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Fruit{}, err
	}
	return typedFrom[Fruit](res), nil
}




func (e *FruitEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FruitListMatch and returns []Fruit. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FruitEntity) ListTyped(reqmatch FruitListMatch, ctrl map[string]any) ([]Fruit, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Fruit](res), nil
}



func (e *FruitEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FruitEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FruitEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FruitEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
