...
func NewHakiEntity(client *core.OnePieceSDK, entopts map[string]any) *HakiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HakiEntity) GetName() string { return e.name }
...
func (e *HakiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HakiEntity) Deleted() bool {
	return e.deleted
}


func (e *HakiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHakiEntity(e.client, opts)
}

func (e *HakiEntity) Data(args ...any) any {
...
func (e *HakiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *HakiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HakiEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *HakiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HakiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HakiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HakiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
