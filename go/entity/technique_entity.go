...
func NewTechniqueEntity(client *core.OnePieceSDK, entopts map[string]any) *TechniqueEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TechniqueEntity) GetName() string { return e.name }
...
func (e *TechniqueEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TechniqueEntity) Deleted() bool {
	return e.deleted
}


func (e *TechniqueEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTechniqueEntity(e.client, opts)
}

func (e *TechniqueEntity) Data(args ...any) any {
...
func (e *TechniqueEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TechniqueEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TechniqueEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *TechniqueEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TechniqueEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TechniqueEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TechniqueEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
