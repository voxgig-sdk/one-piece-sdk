...
func NewDialEntity(client *core.OnePieceSDK, entopts map[string]any) *DialEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DialEntity) GetName() string { return e.name }
...
func (e *DialEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DialEntity) Deleted() bool {
	return e.deleted
}


func (e *DialEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDialEntity(e.client, opts)
}

func (e *DialEntity) Data(args ...any) any {
...
func (e *DialEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dial; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DialEntity) DataTyped(data ...Dial) Dial {
	if len(data) > 0 {
		return typedFrom[Dial](e.Data(asMap(data[0])))
	}
	return typedFrom[Dial](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dial (all fields
// optional at the wire level).
func (e *DialEntity) MatchTyped(match ...Dial) Dial {
	if len(match) > 0 {
		return typedFrom[Dial](e.Match(asMap(match[0])))
	}
	return typedFrom[Dial](e.Match())
}
...
func (e *DialEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DialEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DialLoadMatch and returns an Dial. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DialEntity) LoadTyped(reqmatch DialLoadMatch, ctrl map[string]any) (Dial, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Dial{}, err
	}
	return typedFrom[Dial](res), nil
}




func (e *DialEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DialListMatch and returns []Dial. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DialEntity) ListTyped(reqmatch DialListMatch, ctrl map[string]any) ([]Dial, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Dial](res), nil
}



func (e *DialEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DialEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DialEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DialEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
