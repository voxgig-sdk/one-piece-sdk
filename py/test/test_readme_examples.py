# OnePiece SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OnePieceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OnePieceSDK(...) and OnePieceSDK.test(...) become
#      OnePieceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "onepiece_sdk"
_SDK_CLASS = "OnePieceSDK"
