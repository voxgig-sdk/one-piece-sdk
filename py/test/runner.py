...
class OnePieceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OnePieceTestRunner.getenv("ONEPIECE_TEST_LIVE")
        override = OnePieceTestRunner.getenv("ONEPIECE_TEST_OVERRIDE")
        ...
        explain = OnePieceTestRunner.getenv("ONEPIECE_TEST_EXPLAIN")
