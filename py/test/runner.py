...
class OnePieceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OnePieceTestRunner.getenv("ONE_PIECE_TEST_LIVE")
        override = OnePieceTestRunner.getenv("ONE_PIECE_TEST_OVERRIDE")
        ...
        explain = OnePieceTestRunner.getenv("ONE_PIECE_TEST_EXPLAIN")
