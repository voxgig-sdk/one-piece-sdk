...
from onepiece_sdk.utility import register

# Load features
from onepiece_sdk.feature.base_feature import OnePieceBaseFeature
from onepiece_sdk.features import _has_feature, _make_feature
...
class OnePieceSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "OnePieceSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OnePieceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Chapter(self, data=None) -> "ChapterEntity":
        ...
        from onepiece_sdk.entity.chapter_entity import ChapterEntity
    ...
    def Technique(self, data=None) -> "TechniqueEntity":
        ...
        from onepiece_sdk.entity.technique_entity import TechniqueEntity
    ...
    def Volume(self, data=None) -> "VolumeEntity":
        ...
        from onepiece_sdk.entity.volume_entity import VolumeEntity
